...
**List Bulletin Board Systems (BBS) across archives:**
```bash
...
| `--list-bbs` | List all Bulletin Board Systems (BBS) with conference/message counts and active date ranges, then exit. |
