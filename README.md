...
- **Filtering:** Narrow your view by BBS, conference, author, recipient, or word count limits. Use the **Exclude** field to hide messages matching specific keywords. You can also filter for private messages or messages with attachments.
- **Context Menus:** Right-click a message to copy its details (Subject, From, To, Num), filter or exclude the view by its author, subject, conference, or BBS. In the detail view, you can also copy selected text or search for it instantly.
...
- **Ctrl + Shift + X**: Reset all filters and search fields instantly.
