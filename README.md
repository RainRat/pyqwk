...
**List extracted email addresses across archives:**
```bash
...
| `--list-msg-links`, `--list-message-links` | List all extracted internal message link references across input archives with message counts, author counts, and active date ranges, then exit. |
