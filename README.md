...
- **Filtering:** Narrow your view by BBS, conference, author, or recipient. Use the **Exclude** field to hide messages matching specific keywords. You can also filter for private messages, word limits, or messages with attachments.
- **Context Menus:** Right-click a message to copy its details, filter or exclude the view by its author or conference, or search for selected text.
