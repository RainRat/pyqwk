...
- **Context Menus:** Right-click a message to copy its details, filter your view, or exclude specific details like authors and conferences. Right-click the message text to select or copy it.
