...
**Filter by Reply Reference:**
```bash
# Show replies to specific message numbers
qwk archive.qwk --reply-to 100,105,200-210
```
...
| `-R, --reply-to` | Show replies to specific message numbers or ranges. Alias: `--refnum`. |
