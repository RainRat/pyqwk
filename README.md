...
**Find Content:**
```bash
# Show messages that contain links
qwk archive.qwk --has-links

# Show messages that contain phone numbers
qwk archive.qwk --has-phones

# Show messages that contain email addresses
qwk archive.qwk --has-emails

# Show messages that contain color codes
