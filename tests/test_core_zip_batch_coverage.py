    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with zipfile.ZipFile(zip_path, "w") as zf:
            ...
            with open(f1_path, "w") as f:
                f.write(
                    '[{"header": {"msgfrom": "A", "msgsubject": "S", "confnum": 1}, "text": "B"}]'
                )
            ...
            with open(f2_path, "w") as f:
                f.write(
                    '[{"header": {"msgfrom": "A2", "msgsubject": "S2", "confnum": 2}, "text": "B2", "bbs_name": "RealBBS"}]'
                )
...
def test_zip_batch_no_messages_raises_error():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with pytest.raises(
            ValueError, match="No messages could be loaded from ZIP archive"
        ):
