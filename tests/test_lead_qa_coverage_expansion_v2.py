...
from pyqwk.core import ParsedMessage, MessageHeader, process_merged_files, ProcessingSettings, matches_filters
...
def _make_settings(**kwargs):
    defaults = dict(
        ...
        individual_files=False, threaded=True,
...
def test_gui_load_structured_data(app):
    ...
    with patch("pyqwk.gui.load_data", return_value=mock_data), \
...
def test_prompt_jump_to_message_invalid_selection(app):
    ...
    with patch("pyqwk.gui.simpledialog.askinteger", return_value=101), \
...
def test_prompt_jump_to_message_global_fallback(app):
    ...
    h1 = MessageHeader(" ", 101, "01-01-23", "12:00", "To1", "From1", "Subj1", "", None, 1, " ", 1, 1, "")
    h2 = MessageHeader(" ", 102, "01-01-23", "12:05", "To2", "From2", "Subj2", "", None, 1, " ", 2, 1, "")
    app.messages = [
...
def test_threading_visited_branches():
    ...
    h1 = MessageHeader(" ", 1, "01-01-23", "12:00", "To1", "From1", "Subj1", "", None, 1, " ", 1, 1, "")
    h2 = MessageHeader(" ", 2, "01-01-23", "12:05", "To2", "From2", "Subj2", "", "1", 1, " ", 1, 1, "")
    h3 = MessageHeader(" ", 3, "01-01-23", "12:10", "To3", "From3", "Subj3", "", "3", 1, " ", 1, 1, "")
