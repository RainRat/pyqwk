...
def test_header_format_text_redaction():
    header = MessageHeader(
        ...
        msgto='user@example.com', msgfrom='555-1234', msgsubject='Secret 123-456-7890',
        msgpassword='', refnum=None, numblocks=1, msgflag='', confnum=1, lognum=1, nettag=''
    )
...
def test_get_message_mapping_redaction():
    ...
    msg = ParsedMessage(text="Body with 111-222-3333", msgnum=1, refnum=None, confnum=1, header=header)
