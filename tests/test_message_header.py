...
class TestMessageHeaderFormatting:
    ...
    def test_format_text_verbose_conf_not_found(
        self, sample_header: MessageHeader
    ) -> None:
    ...
    def test_format_text_no_separator(self, sample_header: MessageHeader) -> None:
        ...
        board_dict = {1: "General"}
        text = sample_header.format_text(
            board_dict, verbose=False, include_separator=False
        )
    ...
    def test_format_text_with_attachments(self, sample_header: MessageHeader) -> None:
        ...
        text = sample_header.format_text(
            board_dict, verbose=True, attachments=attachments
        )
