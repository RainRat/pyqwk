...
def test_deduplication_by_msgnum(tmp_path):
    ...
    msg1 = ParsedMessage(
        text="Message 1", msgnum=1, refnum=None, confnum=100, header=h1
    )
    ...
    msg2 = ParsedMessage(
        text="Message 1 Duplicate", msgnum=1, refnum=None, confnum=100, header=h2
    )
    ...
    msg3 = ParsedMessage(
        text="Message 2", msgnum=2, refnum=None, confnum=100, header=h3
    )
...
def test_deduplication_by_content_hash(tmp_path):
    ...
    msg1 = ParsedMessage(
        text="Message Content", msgnum=None, refnum=None, confnum=100, header=h1
    )
    ...
    msg2 = ParsedMessage(
        text="Message Content", msgnum=None, refnum=None, confnum=100, header=h2
    )
    ...
    msg3 = ParsedMessage(
        text="Different Content", msgnum=None, refnum=None, confnum=100, header=h3
    )
