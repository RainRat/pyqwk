...
def test_gui_message_list_icons_and_tags(mock_gui_deps):
    ...
    h1 = MessageHeader(
        status='*', # '*' is private
        msgnum=101, msgdate='01-01-23', msgtime='12:00',
        msgto='Recipient', msgfrom='Sender', msgsubject='Private with Attach',
        msgpassword='', refnum=None, numblocks=2, msgflag=' ',
        confnum=1, lognum=1, nettag=''
    )
    m1 = ParsedMessage(
        text="Body", msgnum=101, refnum=None, confnum=1, header=h1,
    ...
    h2 = MessageHeader(
        status=' ', # ' ' is public
        msgnum=102, msgdate='01-01-23', msgtime='12:05',
        msgto='All', msgfrom='Sender', msgsubject='Public No Attach',
        msgpassword='', refnum=None, numblocks=2, msgflag=' ',
        confnum=1, lognum=1, nettag=''
    )
    m2 = ParsedMessage(
        text="Body", msgnum=102, refnum=None, confnum=1, header=h2,
        attachments=[]
    )
    ...
    h3 = MessageHeader(
        status='*',
        msgnum=103, msgdate='01-01-23', msgtime='12:10',
        msgto='Recipient', msgfrom='Sender', msgsubject='Private No Attach',
        msgpassword='', refnum=None, numblocks=2, msgflag=' ',
        confnum=1, lognum=1, nettag=''
    )
    m3 = ParsedMessage(
        text="Body", msgnum=103, refnum=None, confnum=1, header=h3,
        attachments=None
    )
    ...
    h4 = MessageHeader(
        status='*',
        msgnum=104, msgdate='01-01-23', msgtime='12:15',
        msgto='Recipient', msgfrom='Sender', msgsubject='Private odd index',
        msgpassword='', refnum=None, numblocks=2, msgflag=' ',
        confnum=1, lognum=1, nettag=''
    )
    m4 = ParsedMessage(
        text="Body", msgnum=104, refnum=None, confnum=1, header=h4,
    ...
    with patch("pyqwk.gui.load_data", return_value=(messages, board_dict)), \
