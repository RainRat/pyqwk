...
def test_oneline_individual_files_conflict(monkeypatch, testdata_dir, capsys):
    ...
    monkeypatch.setattr(sys, "argv", ["qwk", str(input_file), "--oneline", "--individual-files", "-o", "dummy"])
...
def test_threading_circular_reference_logging(message_factory, caplog, logger):
    ...
    h1 = MessageHeader(status=' ', msgnum=1, msgdate='01-01-23', msgtime='12:00', msgto='A', msgfrom='B', msgsubject='S', msgpassword='', refnum=2, numblocks=1, msgflag='', confnum=1, lognum=1, nettag='')
    h2 = MessageHeader(status=' ', msgnum=2, msgdate='01-01-23', msgtime='12:01', msgto='A', msgfrom='B', msgsubject='S', msgpassword='', refnum=1, numblocks=1, msgflag='', confnum=1, lognum=2, nettag='')
