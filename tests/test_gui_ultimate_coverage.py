...
def test_sort_column_from_messages(app):
    ...
    h1 = MessageHeader(' ', 1, "01-01-90", "12:00", "To1", "From1", "Sub1", "", None, 1, " ", 1, 1, "")
    h2 = MessageHeader(' ', 2, "02-01-90", "13:00", "To2", "From2", "Sub2", "", None, 1, " ", 2, 1, "")

    app.messages = [
        ParsedMessage("Body1", 1, None, 1, h1, bbs_name="BBS1"),
        ParsedMessage("Body2", 2, None, 2, h2, bbs_name="BBS2", attachments=["file.txt"])
    ]
