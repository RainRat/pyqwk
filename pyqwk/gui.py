...
class QwkGuiApp:
    ...
    def _build_toolbar(self) -> None:
        ...
        # Create a style for group headers to improve visual hierarchy
        style = ttk.Style()
        style.configure("GroupHeader.TLabel", font=("TkDefaultFont", 9, "bold"))
        ...
        ttk.Label(actions_frame, text="File", style="GroupHeader.TLabel").pack(side=tk.LEFT)
        ...
        ttk.Label(nav_frame, text="Messages", style="GroupHeader.TLabel").pack(side=tk.LEFT)
        ...
        for i, (text, var) in enumerate([
            ...
            ).pack(side=tk.LEFT, padx=(10 if i == 0 else 5, 5))
