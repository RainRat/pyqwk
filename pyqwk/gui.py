...
class QwkGuiApp:
    ...
    def _build_layout(self) -> None:
        ...
        self.message_list.column("Flags", minwidth=40, width=60, anchor=tk.CENTER, stretch=False)
        self.message_list.column("Num", minwidth=50, width=60, anchor=tk.E, stretch=False)
        ...
        self.message_list.column("Size", minwidth=60, width=70, anchor=tk.E, stretch=False)
        self.message_list.column("Conference", minwidth=50, width=120)
