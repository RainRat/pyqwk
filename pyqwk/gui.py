...
class QwkGuiApp:
    ...
    def _reset_visibility_filters(self) -> None:
        """Reset all nine visibility checkboxes to their default values (Private=True, others=False) and reload."""
    ...
    def _build_toolbar(self) -> None:
        ...
        ).grid(row=0, column=3, rowspan=3, padx=(5, 2), pady=2, sticky=tk.NS)
