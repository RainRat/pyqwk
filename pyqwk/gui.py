...
class QwkGuiApp:
    ...
    def _build_toolbar(self) -> None:
        ...
        self.bbs_combo.grid(row=0, column=1, padx=2)
        ttk.Button(
            archives_frame, text="▶", width=2, command=lambda: self._navigate_bbs(1)
        ...
        ).grid(row=1, column=0, padx=(2, 0), pady=(2, 0))
        self.conf_combo = ttk.Combobox(archives_frame, state="readonly", width=18)
        self.conf_combo.grid(row=1, column=1, padx=2, pady=(2, 0))
        ttk.Button(
            archives_frame, text="▶", width=2, command=lambda: self._navigate_conference(1)
        ).grid(row=1, column=2, padx=(0, 2), pady=(2, 0))
