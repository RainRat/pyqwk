...
class QwkGuiApp:
    ...
    def _build_toolbar(self) -> None:
        ...
        btn_clear_search.pack(side=tk.LEFT, padx=(0, 5))
        ToolTip(btn_clear_search, "Clear search text")
        ...
        ToolTip(btn_clear_exclude, "Clear exclude text")
        ...
        ToolTip(btn_reset_filters, "Reset visibility filters")
        ...
        btn_reset_words = ttk.Button(
            limits_frame,
            text="✕",
            width=2,
            command=self._reset_word_limits,
        )
        btn_reset_words.pack(side=tk.LEFT, padx=(2, 0))
        ToolTip(btn_reset_words, "Reset word limits")
        ...
        ToolTip(btn_reset_display, "Reset display options")
