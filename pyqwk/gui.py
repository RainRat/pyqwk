...
class QwkGuiApp:
    ...
    def _build_layout(self) -> None:
        ...
        self.message_list.column(
            "Flags", minwidth=60, width=60, anchor=tk.CENTER, stretch=False
        )
        self.message_list.column(
            "Num", minwidth=60, width=60, anchor=tk.E, stretch=False
        )
        ...
        self.message_list.column(
            "Size", minwidth=70, width=70, anchor=tk.E, stretch=False
        )
        self.message_list.column("Conference", minwidth=100, width=120)
        self.message_list.column("BBS", minwidth=100, width=120)
