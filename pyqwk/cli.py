...
""",
    ...
    parser.add_argument(
        ...
        "--list-message-links",
        action="store_true",
        help="List all extracted internal message links across input archives with message counts, author counts, and active date ranges, then exit. You can save this to a file with -o.",
    )
    parser.add_argument(
        "-V",
        "--version",
