...
def _parse_rfc_date_string(date_str: str | None) -> tuple[str, str]:
    """Parse an RFC 2822/5322 date-time string into standard QWK date and time formats."""
    if not date_str:
...
def _message_from_email(msg_obj: Any) -> ParsedMessage:
    ...
    # Date/Time
    try:
        msg_date, msg_time = _parse_rfc_date_string(get_hdr("Date"))
    except ValueError:
        msg_date, msg_time = "01-01-70", "00:00"
