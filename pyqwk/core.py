...
def _render_csv_table(
    ...
    """Render a list of dictionary records into a CSV string."""
    output = io.StringIO()
...
def _render_urls_csv(url_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        url_list, ["url", "message_count", "authors_count", "first_active", "last_active", "bbs_name"]
    )
...
def _render_emails_csv(email_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        email_list, ["email", "message_count", "authors_count", "first_active", "last_active", "bbs_name"]
    )
...
def _render_conferences_csv(conf_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        conf_list, ["number", "name", "message_count", "bbs_name"]
    )
...
def _render_authors_csv(author_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        author_list, ["author", "message_count", "first_active", "last_active", "bbs_name"]
    )
...
def _render_recipients_csv(recipient_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        recipient_list, ["recipient", "message_count", "first_active", "last_active", "bbs_name"]
    )
...
def _render_subjects_csv(subject_list: list[dict[str, Any]]) -> str:
    return _render_csv_table(
        subject_list, ["subject", "message_count", "authors_count", "first_active", "last_active", "bbs_name"]
    )
